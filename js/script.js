...
$(document).ready(function(){
	...
	$(document).on('tap','.edit-functions',  function(){
		...
		addFunction.find('a').removeClass('ui-icon-carat-r').removeClass('ui-invisible').addClass('ui-icon-plus').addClass('add-function').html('Dodaj funkcję').attr('href', '#add-function');
